// setpath.c -- created by Will Sussman on December 31, 2019
...
int main(int argc, char **argv){
	...
	/* Handle inputs */
	if(argc != 4){
		fprintf(stderr,"usage: setpath topfile PCport PCtimeout\n");
		fprintf(stderr,"example: setpath jan16top.txt 4013 0\n");
